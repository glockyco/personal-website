...
export const PublicationSchema = z.object({
  ...
  /** ≤155-char SERP-facing description. Falls back to `tldr`, then auto-generated. */
...
const rawPublications = [
  {
    ...
    metaDescription:
      'Differential symbolic execution with best-effort heuristics for cases where formal equivalence proofs fail — outperforms three existing tools by 3–7%.',
  ...
  },
  {
    ...
    metaDescription:
      'Semantics-based test generalization that transforms JUnit unit tests into property-based jqwik tests by deriving specifications from program semantics.',
  ...
  },
  {
    ...
    metaDescription:
      'Interview study of 17 practitioners across 11 companies identifying six microservice API evolution strategies, six challenges, and two core problems.',
  ...
  },
  {
    ...
    metaDescription:
      'Doctoral symposium paper proposing equivalence checking that emphasizes developer-oriented explanations of behavioral differences over raw accuracy.',
  ...
  },
  {
    ...
    tldr: 'A large-scale mining study of 90,000 Maven Central projects finds that design patterns are positively correlated with software functionality and reusability but negatively correlated with understandability — consistent with smaller prior studies.',
    metaDescription:
      'Mining 90,000 Maven Central projects to study how design patterns correlate with software quality — confirming functionality and reusability gains.',
